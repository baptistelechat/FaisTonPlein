...
- [x] **Tri et Filtrage** :
  - Par défaut : Tri par **distance **(Top 3 mis en avant).
...
- [x] Le composant `StationList` est implémenté et intégré.
- [x] Le tri par prix et distance fonctionne correctement.
- [x] L'affichage est responsive et utilisable sur mobile.
- [x] Tests unitaires pour la fonction de tri et de distance.
