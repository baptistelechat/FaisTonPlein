  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "border-primary/50 group/drawer-content bg-background fixed z-50 flex h-auto flex-col text-sm",
      ...
      >
        ...
        <div className="bg-primary/10 mx-auto mt-4 h-2 w-25 shrink-0 rounded-full group-data-[vaul-drawer-direction=top]/drawer-content:hidden" />

        {children}

        {/* Drag Handle for Top Drawer */}
        <div className="bg-primary/10 mx-auto mb-4 hidden h-2 w-25 shrink-0 rounded-full group-data-[vaul-drawer-direction=top]/drawer-content:block" />
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
}
